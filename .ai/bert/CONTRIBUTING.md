...
This file, CONTRIBUTING.md, and the bert/ folder were primarily created by Google Research.

## License

Google released BERT under the Apache License 2.0.

## Original Repository

The original repository where the code is located is:
